      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-3 text-xs text-muted-foreground">Registered children</p>
          </div>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-3 text-xs text-muted-foreground">Combined achievements</p>
          </div>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-3 text-xs text-muted-foreground">New this month</p>
          </div>
